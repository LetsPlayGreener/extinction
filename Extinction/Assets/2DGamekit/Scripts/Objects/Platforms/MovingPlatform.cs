    ...
    public class MovingPlatform : MonoBehaviour
    {
        ...
        public void StartMoving()
        {
            ...
            if (LearningAnalyticsGenerator.instance && LearningAnalyticsGenerator.instance.canGenerateLA)
                GBL_Interface.SendStatement("activated", "interactable", "MovingPlateform", new Dictionary<string, List<string>>()
                    {
                        { "position", new List<string>() { transform.position.ToString() } }
                    });
        }
