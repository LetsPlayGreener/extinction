...
namespace Gamekit2D
{
    ...
    public class Pushable : MonoBehaviour
    {
        ...
        private Vector3 startingPushPosition;
        ...
        public void StartPushing()
        {
            ...
            startingPushPosition = pushablePosition.position;
        }
        ...
        public void EndPushing()
        {
            ...
            if (LearningAnalyticsGenerator.instance && LearningAnalyticsGenerator.instance.canGenerateLA)
                GBL_Interface.SendStatement("moved", "interactable", "PushableBox", new Dictionary<string, List<string>>()
                    {
                        { "from", new List<string>() { startingPushPosition.ToString() } },
                        { "position", new List<string>() { pushablePosition.position.ToString() } }
                    });
        }
